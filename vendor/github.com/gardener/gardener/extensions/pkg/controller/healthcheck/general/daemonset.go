...
func (healthChecker *DaemonSetHealthChecker) Check(ctx context.Context, request types.NamespacedName, errorCodeDetector errorutil.ErrorCodeDetector) (*healthcheck.SingleCheckResult, error) {
